  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#c5cbce]">
      <div className="flex flex-col md:flex-row items-center min-h-[500px] lg:min-h-[600px] max-w-[1600px] mx-auto">
        ...
        <div className="relative w-full md:w-[55%] lg:w-[50%] h-[400px] md:h-[500px] lg:h-[600px] flex items-end justify-center">
          {!isImageLoaded && (
        ...
        {/* Right: Text Content */}
        <div className="w-full md:w-[45%] lg:w-[50%] flex flex-col justify-center items-center text-center px-8 sm:px-12 py-16 md:py-0 mt-8 md:mt-0">
