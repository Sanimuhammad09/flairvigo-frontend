...
import { nt as useRouter, s as useRouterState } from "./index.dev-ZlZhaXxJ.js";
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-CnpwH7La-BRTOPhHx.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) BaseTanStackRouterDevtoolsPanel = this.#Component;
				...
				BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-SWyE65Is-CRgsI06e.js"));
...
//#endregion
//#region node_modules/@tanstack/router-devtools/dist/esm/index.js
...
//#endregion
export { TanStackRouterDevtoolsInProd as TanStackRouterDevtools, TanStackRouterDevtoolsPanelInProd as TanStackRouterDevtoolsPanel };
