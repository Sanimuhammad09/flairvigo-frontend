  ...
  Women: {
    columns: [
      ...
      },
      {
        title: 'Scrubs',
        links: [
          { name: 'All Scrubs', path: '/collections/women' },
          { name: 'Scrub Tops', path: '/collections/women' },
          { name: 'Scrub Pants', path: '/collections/women' },
          { name: 'Scrub Sets', path: '/collections/women' },
          { name: 'ScrubJumpsuits™', path: '/collections/women' },
          { name: 'ScrubLeggings™', path: '/collections/women' },
          { name: 'Maternity Scrubs', path: '/collections/women' },
        ],
      },
      {
        title: 'Shop by Fabric',
        links: [
          { name: 'FIONx™ (Soft + Breathable)', path: '/collections/women' },
          { name: 'FORMx™ (Stretch + Comfort)', path: '/collections/women' },
          { name: 'FlexKnit (Flexible + Airy)', path: '/collections/women' },
        ],
      },
      {
        title: 'Outerwear and Underscrubs',
        links: [
          { name: 'Jackets and Vests', path: '/collections/women' },
          { name: 'Underscrubs and Tees', path: '/collections/women' },
          { name: 'Lab Coats', path: '/collections/women' },
          { name: 'Loungewear', path: '/collections/women' },
        ],
      },
      {
        title: 'Footwear and Accessories',
        links: [
          { name: 'FIGS | New Balance', path: '/collections/women' },
          { name: 'Socks', path: '/collections/women' },
          { name: 'Accessories', path: '/collections/women' },
          { name: 'Bags', path: '/collections/women' },
        ],
      },
    ],
  },
    ...
    columns: [
      {
        title: 'Highlights',
        links: [
          { name: 'Celery • Deep Purple', path: '/collections/men', badge: 'NEW' },
          { name: 'New Arrivals', path: '/collections/new-arrivals' },
          { name: 'Best Sellers', path: '/collections/best-sellers' },
          { name: 'THE SET', path: '/collections/men' },
          { name: 'Sale', path: '/collections/sale' },
        ],
      },
      {
        title: 'Scrubs',
        links: [
          { name: 'All Scrubs', path: '/collections/men' },
          { name: 'Scrub Tops', path: '/collections/men' },
          { name: 'Scrub Pants', path: '/collections/men' },
          { name: 'Scrub Sets', path: '/collections/men' },
        ],
      },
      {
        title: 'Shop by Fabric',
        links: [
          { name: 'FIONx™ (Soft + Breathable)', path: '/collections/men' },
          { name: 'FORMx™ (Stretch + Comfort)', path: '/collections/men' },
          { name: 'FlexKnit (Flexible + Airy)', path: '/collections/men' },
        ],
      },
      {
        title: 'Outerwear and Underscrubs',
        links: [
          { name: 'Jackets and Vests', path: '/collections/men' },
          { name: 'Underscrubs and Tees', path: '/collections/men' },
          { name: 'Lab Coats', path: '/collections/men' },
          { name: 'Loungewear', path: '/collections/men' },
        ],
      },
      {
        title: 'Footwear and Accessories',
        links: [
          { name: 'FIGS | New Balance', path: '/collections/men' },
          { name: 'Socks', path: '/collections/men' },
          { name: 'Accessories', path: '/collections/men' },
          { name: 'Bags', path: '/collections/men' },
        ],
      },
    ],
  },
...
const mobileMenuSections = [
  {
    title: 'Women',
    links: [
      { name: 'All Women', path: '/collections/women' },
      { name: 'Scrub Tops', path: '/collections/women' },
      { name: 'Scrub Pants', path: '/collections/women' },
      { name: 'New Arrivals', path: '/collections/new-arrivals' },
    ],
  },
  {
    title: 'Men',
    links: [
      { name: 'All Men', path: '/collections/men' },
      { name: 'Scrub Tops', path: '/collections/men' },
      { name: 'Scrub Pants', path: '/collections/men' },
      { name: 'New Arrivals', path: '/collections/new-arrivals' },
    ],
